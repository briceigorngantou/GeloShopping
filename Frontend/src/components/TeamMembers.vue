...
<section class="py-6">
		<div class="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
			<p class="p-2 text-xl tracking-wider text-center uppercase text-white font-bold">Development team</p>
			<h1 class="text-4xl font-bold leading-none text-center sm:text-5xl text-secondary ">The talented people behind the scenes</h1>
			<div class="flex flex-col grid-flow-row lg:flex-row">
        <div class="flex flex-row flex-wrap-reverse justify-center mt-8" v-for="person in people" :key="person.name">
          <div class="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
            <img alt="" class="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" :src="person.imageUrl">
            <div class="flex-1 my-4">
              <p class="text-xl font-semibold leading-snug">{{person.name}}</p>
              <p>{{person.role}}</p>
            </div>
            <div class="flex items-center justify-center p-3 space-x-3 border-t-2">
              <a rel="noopener noreferrer" href="#" title="Email" class="dark:text-gray-900 hover:dark:text-secondary">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                </svg>
              </a>
              <a rel="noopener noreferrer" href="#" title="Twitter" class="dark:text-gray-900 hover:dark:text-secondary">
              ...
              <a rel="noopener noreferrer" href="#" title="LinkedIn" class="dark:text-gray-900 hover:dark:text-secondary">
              ...
              <a rel="noopener noreferrer" href="#" title="GitHub" class="dark:text-gray-900 hover:dark:text-secondary">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-5 h-5">
