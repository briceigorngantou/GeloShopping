<template>
    <footer>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28 container ">
        <div>
          <div class="flex gap-2 mb-5">
            <h1 class="text-white font-bold text-2xl">GELO<span class="text-secondary">SHOPP</span>ING</h1>
          ...
          <p class="text-white leading-loose lg:text-left md:text-center tracking-wide w-full md:w-[80%]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum fringilla ultricies eget amet blandit quis sit duis. Suspendisse fames venenatis volutpat urna dui. Quisque non diam mi ullamcorper.</p>
          <div class="flex justify-end md:justify-start -mt-7 md:mt-3">
            <img class="w-12 md:-translate-x-10 scale-x-[-1] md:scale-100" src="../assets/shop-e-commerce-GIF-by-Privali-unscreen.gif" alt="">
          </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 justify-center gap-12 text-white">
          <div>
      ...
      <div class="grid place-items-center my-20 w-full ">
        <div class="flex items-center gap-10">
          <a href="" class="bg-secondary h-12 w-12 grid place-items-center rounded-md focus-within:bg-white hover:bg-primary-100">
        ...
        <p class="md:text-lg font-medium text-center text-white mt-8 tracking-wider bottom-[0px] ">
          &copy; Copyright, GELOSHOPPING 2023, All rights reserved.
        </p>
      </div>
    </footer>
  </template>